...
openspec_buddy_apply_optional_defaults() {
  ...
  export OPENSPEC_BUDDY_REVIEW_POLL_SECONDS="${OPENSPEC_BUDDY_REVIEW_POLL_SECONDS:-60}"
  ...
  export OPENSPEC_BUDDY_CACHE_SIGNAL_REF="${OPENSPEC_BUDDY_CACHE_SIGNAL_REF:-}"
  export OPENSPEC_BUDDY_CACHE_SIGNAL_REMOTE="${OPENSPEC_BUDDY_CACHE_SIGNAL_REMOTE:-origin}"
}
